        ...
        <div class="input">
            ...
            <ul>
                <li>
                    ...
                    <input class="form-control form-control-lg" type="number" placeholder=".form-control-lg" aria-label=".form-control-lg example" name="d" autofocus >
                        <label for="floatingInput">Diameter (D) (cm)</label>
                    </div>
                </li>
                <li>
                    <div class="form-floating mb-3">
                    <input class="form-control form-control-lg" type="number" placeholder=".form-control-lg" aria-label=".form-control-lg example" name="r">
                        <label for="floatingInput">Jari-Jari (r) (cm)</label>
                    </div>
                </li>
                <li>
                    <div class="form-floating mb-3">
                    <input class="form-control form-control-lg harga" type="number" placeholder=".form-control-lg" aria-label=".form-control-lg example" name="t" required>
